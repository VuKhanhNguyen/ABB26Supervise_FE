...
export function AlertCard({ title, category, description, tag, timeLabel, icon, variant }: Props) {
  ...
  return (
    <View className={`relative overflow-hidden rounded-lg bg-surface-container shadow-sm mb-4 ${containerBorder}`}>
